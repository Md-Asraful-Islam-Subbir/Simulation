#A bullet is fired at an angle of 40° with horizontal and with an initial velocity of 350 meter/sec.
# Assuming that the air resistance varies as the square of the velocity of the bullet and that the resistance coefficient is -0.00005, find the range, time of flight, and the angle of fall of the bullet.
import math
