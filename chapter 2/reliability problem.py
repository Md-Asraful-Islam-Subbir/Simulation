...
time_spent_in_bearing_replacement = (total_change * one_bearing_change_time_minutes) - (
            two_down * (two_bearing_change_time_minutes - one_bearing_change_time_minutes)) - (three_down * (
            three_bearing_change_time_minutes - one_bearing_change_time_minutes))
...
print("\n")
total_estimated_cost_old_policy = cost_of_repairman + cost_of_bearing + cost_of_downtime
print("Total estimated cost = Rs.", total_estimated_cost_old_policy)
...
print("\n")
total_estimated_cost_new_policy = cost_of_repairman + cost_of_bearing + cost_of_downtime
print("Total estimated cost = Rs.", total_estimated_cost_new_policy)